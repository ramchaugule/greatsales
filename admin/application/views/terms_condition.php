               ...
               <div class="row">
                  <div class="col-lg-6">
                     <div class="dashboard_header_title">
                        <h3>Terms & Condition Update</h3>
                     </div>
                  </div>
                  <div class="col-lg-6">
                     <div class="dashboard_breadcam text-end">
                        <p><a href="index.html">Dashboard</a> <i class="fas fa-caret-right"></i> Terms & Condition Update</p>
                     </div>
                  </div>
               </div>
            </div>
                  ...
                  <div class="col-lg-12">
                     <div class="modal-content cs_modal">
                        <div class="modal-header theme_bg_1 justify-content-center" style="background: #204176!important;">
                           <h5 class="modal-title text_white">Terms & Condition Update</h5>
                        </div>
                        <?php foreach($terms_condition_details as $dt) { ?>
                        <div class="modal-body">
                           <form action="<?php echo base_url(); ?>index.php/Menus/terms_condition_update" method="POST" enctype="multipart/form-data">

                           <div class="" >
						   	<textarea name="terms_condition_content"  id="kt-ckeditor-1">
                           		<?php echo $dt['terms_condition_content']; ?>
                        	</textarea>

               ...
               <div class="row">
                  ...
                  <div class="col-lg-6">
                     <div class="dashboard_breadcam text-end">
                        <p><a href="<?php echo base_url(); ?>">Dashboard</a> <i class="fas fa-caret-right"></i> Sub Category Add</p>
                     </div>
                  </div>
               </div>
            </div>
                  ...
                  <div class="col-lg-7">
                     <div class="modal-content cs_modal">
                        <div class="modal-header theme_bg_1 justify-content-center" style="background: #204176!important;">
                           <h5 class="modal-title text_white">Add Sub Category</h5>
                        </div>
                        <div class="modal-body">
                           <form action="<?php echo base_url(); ?>index.php/Menus/subcategory_save" method="POST" enctype="multipart/form-data">

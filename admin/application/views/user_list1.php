...
<head>
      ...
      <title>Great Sales Admin</title>
      <link rel="icon" href="<?php echo base_url(); ?>assets/img/mini_logo.png" type="image/png">
      ...
      <link rel="stylesheet" href="<?php echo base_url(); ?>assets/vendors/datepicker/date-picker.css" />
      <link rel="stylesheet" href="<?php echo base_url(); ?>assets/vendors/vectormap-home/vectormap-2.0.2.css" />
      <link rel="stylesheet" href="<?php echo base_url(); ?>assets/vendors/scroll/scrollable.css" />
   ...
   <body class="crm_body_bg">
      <nav class="sidebar">
         <div class="logo d-flex justify-content-between">
            <a class="large_logo" href="index.html"><img src="<?php echo base_url(); ?>assets/img/great_sales.PNG" alt=""></a>
            <a class="small_logo" href="index.html"><img src="assets/img/mini_logo.png" alt=""></a>
         ...
         <ul id="sidebar_menu">
            <li class="">
               <a class="has-arrow" href="#" aria-expanded="false">
                  <div class="nav_icon_small">
                     <img src="<?php echo base_url(); ?>assets/img/menu-icon/dashboard.svg" alt="">
                  </div>
                  <div class="nav_title">
            ...
            <li class="">
               <a class="has-arrow" href="#" aria-expanded="false">
                  <div class="nav_icon_small">
                     <img src="<?php echo base_url(); ?>assets/img/menu-icon/2.svg" alt="">
                  </div>
                  <div class="nav_title">
            ...
            <li class="">
               <a class="has-arrow" href="#" aria-expanded="false">
                  <div class="nav_icon_small">
                     <img src="<?php echo base_url(); ?>assets/img/menu-icon/3.svg" alt="">
                  </div>
                  <div class="nav_title">
                     <span>Pages</span>
                  </div>
            ...
            <li class="">
               <a class="has-arrow" href="#" aria-expanded="false">
                  <div class="nav_icon_small">
                     <img src="<?php echo base_url(); ?>assets/img/menu-icon/4.svg" alt="">
                  </div>
                  <div class="nav_title">
                     <span>Admins</span>
                  </div>
            ...
            <li class="">
               <a class="has-arrow" href="#" aria-expanded="false">
                  <div class="nav_icon_small">
                     <img src="<?php echo base_url(); ?>assets/img/menu-icon/11.svg" alt="">
                  </div>
                  <div class="nav_title">
            ...
            <li class="">
               <a href="navs.html" aria-expanded="false">
                  <div class="nav_icon_small">
                     <img src="<?php echo base_url(); ?>assets/img/menu-icon/12.svg" alt="">
                  </div>
                  <div class="nav_title">
                     <span>Navs</span>
                  </div>
            ...
            <li class="">
               <a class="has-arrow" href="#" aria-expanded="false">
                  <div class="nav_icon_small">
                     <img src="<?php echo base_url(); ?>assets/img/menu-icon/5.svg" alt="">
                  </div>
                  <div class="nav_title">
                     <span>Users</span>
                  </div>
               ...
               <ul>
                  <li><a href="<?php echo base_url(); ?>index.php/Menus/user_list1">Users List</a></li>
            ...
            <li>
               <a href="Builder.html" aria-expanded="false">
                  <div class="nav_icon_small">
                     <img src="<?php echo base_url(); ?>assets/img/menu-icon/6.svg" alt="">
                  </div>
                  <div class="nav_title">
                     <span>Builder </span>
                  </div>
            ...
            <li class="">
               <a href="invoice.html" aria-expanded="false">
                  <div class="nav_icon_small">
                     <img src="<?php echo base_url(); ?>assets/img/menu-icon/7.svg" alt="">
                  </div>
                  <div class="nav_title">
                     <span>Invoice</span>
                  </div>
            ...
            <li class="">
               <a class="has-arrow" href="#" aria-expanded="false">
                  <div class="nav_icon_small">
                     <img src="<?php echo base_url(); ?>assets/img/menu-icon/8.svg" alt="">
                  </div>
                  <div class="nav_title">
                     <span>forms</span>
                  </div>
            ...
            <li class="">
               <a href="Board.html" aria-expanded="false">
                  <div class="nav_icon_small">
                     <img src="<?php echo base_url(); ?>assets/img/menu-icon/9.svg" alt="">
                  </div>
                  <div class="nav_title">
                     <span>Board</span>
                  </div>
            ...
            <li class="">
               <a href="calender.html" aria-expanded="false">
                  <div class="nav_icon_small">
                     <img src="<?php echo base_url(); ?>assets/img/menu-icon/10.svg" alt="">
                  </div>
                  <div class="nav_title">
                     <span>Calander</span>
                  </div>
            ...
            <li class="">
               <a class="has-arrow" href="#" aria-expanded="false">
                  <div class="nav_icon_small">
                     <img src="<?php echo base_url(); ?>assets/img/menu-icon/13.svg" alt="">
                  </div>
                  <div class="nav_title">
                     <span>Products</span>
                  </div>
            ...
            <li class="">
               <a class="has-arrow" href="#" aria-expanded="false">
                  <div class="nav_icon_small">
                     <img src="<?php echo base_url(); ?>assets/img/menu-icon/14.svg" alt="">
                  </div>
                  <div class="nav_title">
                     <span>Icons</span>
                  </div>
            ...
            <li class="">
               <a class="has-arrow" href="#" aria-expanded="false">
                  <div class="nav_icon_small">
                     <img src="<?php echo base_url(); ?>assets/img/menu-icon/15.svg" alt="">
                  </div>
                  <div class="nav_title">
            ...
            <li class="">
               <a class="has-arrow" href="#" aria-expanded="false">
                  <div class="nav_icon_small">
                     <img src="<?php echo base_url(); ?>assets/img/menu-icon/16.svg" alt="">
                  </div>
                  <div class="nav_title">
            ...
            <li class="">
               <a class="has-arrow" href="#" aria-expanded="false">
                  <div class="nav_icon_small">
                     <img src="<?php echo base_url(); ?>assets/img/menu-icon/17.svg" alt="">
                  </div>
                  <div class="nav_title">
                     <span>Table</span>
                  </div>
            ...
            <li class="">
               <a class="has-arrow" href="#" aria-expanded="false">
                  <div class="nav_icon_small">
                     <img src="<?php echo base_url(); ?>assets/img/menu-icon/18.svg" alt="">
                  </div>
                  <div class="nav_title">
                     <span>Cards</span>
                  </div>
            ...
            <li class="">
               <a class="has-arrow" href="#" aria-expanded="false">
                  <div class="nav_icon_small">
                     <img src="<?php echo base_url(); ?>assets/img/menu-icon/19.svg" alt="">
                  </div>
                  <div class="nav_title">
                     <span>Charts</span>
                  </div>
            ...
            <li class="">
               <a class="has-arrow" href="#" aria-expanded="false">
                  <div class="nav_icon_small">
                     <img src="<?php echo base_url(); ?>assets/img/menu-icon/20.svg" alt="">
                  </div>
                  <div class="nav_title">
                     <span>UI Kits </span>
                  </div>
            ...
            <li class="">
               <a class="has-arrow" href="#" aria-expanded="false">
                  <div class="nav_icon_small">
                     <img src="<?php echo base_url(); ?>assets/img/menu-icon/21.svg" alt="">
                  </div>
                  <div class="nav_title">
                     <span>Widgets</span>
                  </div>
                  ...
                  <li>
                     <a href="#">
                        <div class="member_thumb">
                           <img src="<?php echo base_url(); ?>assets/img/staf/1.png" alt="">
                        </div>
                     </a>
                  </li>
                  <li>
                     <a href="#">
                        <div class="member_thumb">
                           <img src="<?php echo base_url(); ?>assets/img/staf/2.png" alt="">
                        </div>
                     </a>
                  </li>
                  <li>
                     <a href="#">
                        <div class="member_thumb">
                           <img src="<?php echo base_url(); ?>assets/img/staf/3.png" alt="">
                        </div>
                     </a>
                  </li>
                  <li>
                     <a href="#">
                        <div class="member_thumb">
                           <img src="<?php echo base_url(); ?>assets/img/staf/4.png" alt="">
                        </div>
                     </a>
                  </li>
                  <li>
                     <a href="#">
                        <div class="member_thumb">
                           <img src="<?php echo base_url(); ?>assets/img/staf/5.png" alt="">
                        </div>
                     </a>
                  </li>
                  <li>
      ...
      <script src="<?php echo base_url(); ?>assets/vendors/datepicker/datepicker.en.js"></script>
      <script src="<?php echo base_url(); ?>assets/vendors/datepicker/datepicker.custom.js"></script>
      <script src="<?php echo base_url(); ?>assets/js/chart.min.js"></script>
      <script src="<?php echo base_url(); ?>assets/vendors/chartjs/roundedBar.min.js"></script>
      ...
      <script src="<?php echo base_url(); ?>assets/vendors/apex_chart/apex-chart2.js"></script>
      <script src="<?php echo base_url(); ?>assets/vendors/apex_chart/apex_dashboard.js"></script>
      ...
      <script src="<?php echo base_url(); ?>assets/js/dashboard_init.js"></script>

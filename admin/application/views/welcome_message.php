                     ...
                     <div class="page_title_box d-flex flex-wrap align-items-center justify-content-between">
                        ...
                        <div class="page_title_right">
                           <div class="page_date_button d-flex align-items-center">
                              <img src="<?php echo base_url(); ?>assets/img/icon/calender_icon.svg" alt="">
                                       ...
                                       <div class="serach_field-area theme_bg d-flex align-items-center">
                                          <div class="search_inner">
                                             <form action="#">
                                                ...
                                                <button type="submit"> <img src="<?php echo base_url(); ?>assets/img/icon/icon_search.svg" alt=""> </button>
                                             </form>
                                          </div>
                                       </div>
                                    </div>
                        ...
                        <div class="white_card_body ">
                           <div class="single_user_pil d-flex align-items-center justify-content-between">
                              <div class="user_pils_thumb d-flex align-items-center">
                                 <div class="thumb_34 mr_15 mt-0"><img class="img-fluid radius_50" src="<?php echo base_url(); ?>assets/img/customers/1.png" alt=""></div>
                           ...
                           <div class="monthly_plan_wraper">
                              <div class="single_plan d-flex align-items-center justify-content-between">
                                 <div class="plan_left d-flex align-items-center">
                                    <div class="thumb">
                                       <img src="<?php echo base_url(); ?>assets/img/icon2/7.svg" alt="">
                                    </div>
                                    <div>
                                       <h5>Most Sales</h5>
                              ...
                              <div class="single_plan d-flex align-items-center justify-content-between">
                                 <div class="plan_left d-flex align-items-center">
                                    <div class="thumb">
                                       <img src="<?php echo base_url(); ?>assets/img/icon2/6.svg" alt="">
                                    </div>
                                    <div>
                              ...
                              <div class="single_plan d-flex align-items-center justify-content-between">
                                 <div class="plan_left d-flex align-items-center">
                                    <div class="thumb">
                                       <img src="<?php echo base_url(); ?>assets/img/icon2/5.svg" alt="">
                                    </div>
                                    <div>
                              ...
                              <div class="row">
                                 <div class="col-lg-6">
                                    <div class="single_plan d-flex align-items-center justify-content-between">
                                       <div class="plan_left d-flex align-items-center">
                                          <div class="thumb">
                                             <img src="<?php echo base_url(); ?>assets/img/icon2/3.svg" alt="">
                                          </div>
                                          <div>
                                             <h5>$2,034</h5>
                                 ...
                                 <div class="col-lg-6">
                                    <div class="single_plan d-flex align-items-center justify-content-between">
                                       <div class="plan_left d-flex align-items-center">
                                          <div class="thumb">
                                             <img src="<?php echo base_url(); ?>assets/img/icon2/1.svg" alt="">
                                          </div>
                                          <div>
                                             <h5>$706</h5>
                                             <span>Commision</span>
                                 ...
                                 <div class="col-lg-6">
                                    <div class="single_plan d-flex align-items-center justify-content-between">
                                       <div class="plan_left d-flex align-items-center">
                                          <div class="thumb">
                                             <img src="<?php echo base_url(); ?>assets/img/icon2/4.svg" alt="">
                                          </div>
                                          <div>
                                             <h5>$49</h5>
                                 ...
                                 <div class="col-lg-6">
                                    <div class="single_plan d-flex align-items-center justify-content-between">
                                       <div class="plan_left d-flex align-items-center">
                                          <div class="thumb">
                                             <img src="<?php echo base_url(); ?>assets/img/icon2/2.svg" alt="">
                                          </div>
                                          <div>
                                             <h5>$5.8M</h5>
                           ...
                           <div class="col-lg-6">
                              <div class="single_crm">
                                 <div class="crm_head d-flex align-items-center justify-content-between">
                                    <div class="thumb">
                                       <img src="<?php echo base_url(); ?>assets/img/crm/businessman.svg" alt="">
                                    </div>
                           ...
                           <div class="col-lg-6">
                              <div class="single_crm ">
                                 <div class="crm_head crm_bg_1 d-flex align-items-center justify-content-between">
                                    <div class="thumb">
                                       <img src="<?php echo base_url(); ?>assets/img/crm/customer.svg" alt="">
                                    </div>
                                    <i class="fas fa-ellipsis-h f_s_11 white_text"></i>
                                 </div>
                                 <div class="crm_body">
                           ...
                           <div class="col-lg-6">
                              <div class="single_crm">
                                 <div class="crm_head crm_bg_2 d-flex align-items-center justify-content-between">
                                    <div class="thumb">
                                       <img src="<?php echo base_url(); ?>assets/img/crm/infographic.svg" alt="">
                                    </div>
                                    <i class="fas fa-ellipsis-h f_s_11 white_text"></i>
                                 </div>
                                 <div class="crm_body">
                           ...
                           <div class="col-lg-6">
                              <div class="single_crm">
                                 <div class="crm_head crm_bg_3 d-flex align-items-center justify-content-between">
                                    <div class="thumb">
                                       <img src="<?php echo base_url(); ?>assets/img/crm/sqr.svg" alt="">
                                    </div>
                                    <i class="fas fa-ellipsis-h f_s_11 white_text"></i>
                                 </div>
                                 <div class="crm_body">
                              ...
                              <table class="table lms_table_active2 p-0">
                                 ...
                                 <tbody>
                                    <tr>
                                       <td>
                                          <div class="customer d-flex align-items-center">
                                             <div class="thumb_34 mr_15 mt-0"><img class="img-fluid radius_50" src="<?php echo base_url(); ?>assets/img/customers/pro_1.png" alt=""></div>
                                    ...
                                    <tr>
                                       <td>
                                          <div class="customer d-flex align-items-center">
                                             <div class="thumb_34 mr_15 mt-0"><img class="img-fluid radius_50" src="<?php echo base_url(); ?>assets/img/customers/pro_2.png" alt=""></div>
                                             <span class="f_s_12 f_w_600 color_text_5">Product 1</span>
                                          </div>
                                       </td>
                                       <td class="f_s_12 f_w_400 color_text_6">$564</td>
                                    ...
                                    <tr>
                                       <td>
                                          <div class="customer d-flex align-items-center">
                                             <div class="thumb_34 mr_15 mt-0"><img class="img-fluid radius_50" src="<?php echo base_url(); ?>assets/img/customers/pro_3.png" alt=""></div>
                                             <span class="f_s_12 f_w_600 color_text_5">Product 1</span>
                                          </div>
                                       </td>
                                       <td class="f_s_12 f_w_400 color_text_6">$564</td>
                                    ...
                                    <tr>
                                       <td>
                                          <div class="customer d-flex align-items-center">
                                             <div class="thumb_34 mr_15 mt-0"><img class="img-fluid radius_50" src="<?php echo base_url(); ?>assets/img/customers/pro_4.png" alt=""></div>
                                             <span class="f_s_12 f_w_600 color_text_5">Product 1</span>
                                          </div>
                                       </td>
                                       <td class="f_s_12 f_w_400 color_text_6">$564</td>
                                    ...
                                    <tr>
                                       <td>
                                          <div class="customer d-flex align-items-center">
                                             <div class="thumb_34 mr_15 mt-0"><img class="img-fluid radius_50" src="<?php echo base_url(); ?>assets/img/customers/pro_5.png" alt=""></div>
                                             <span class="f_s_12 f_w_600 color_text_5">Product 1</span>
                                          </div>
                                       </td>
                                       <td class="f_s_12 f_w_400 color_text_6">$564</td>
                                    ...
                                    <tr>
                                       <td>
                                          <div class="customer d-flex align-items-center">
                                             <div class="thumb_34 mr_15 mt-0"><img class="img-fluid radius_50" src="<?php echo base_url(); ?>assets/img/customers/pro_6.png" alt=""></div>
                                             <span class="f_s_12 f_w_600 color_text_5">Product 1</span>
                                          </div>
                                       </td>
                                       <td class="f_s_12 f_w_400 color_text_6">$564</td>
                     ...
                     <div class="white_card card_height_100 mb_30">
                        ...
                        <div class="white_card_body">
                           <div class="thumb mb_30">
                              <img src="<?php echo base_url(); ?>assets/img/table.svg" alt="" class="img-fluid">
                           </div>

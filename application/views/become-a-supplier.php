...
<?php include('include/header.php'); ?>
        ...
        <main class="main">
            ...
            <div class="page-header">
                <div class="container">
                    <h1 class="page-title mb-0">Become A supplier</h1>
                </div>
            </div>
            <!-- End of Page Header -->
                ...
                <div class="container create-store pb-1 pb-lg-10 mb-10">
                    <div class="row align-items-center">
                        <div class="col-md-6 mb-4 mb-md-0">
                            <figure class="br-sm">
                                <img src="<?php echo base_url(); ?>assets/images/pages/become/1.jpg" alt="Banner"
                    ...
                    <div class="container mt-2 mt-lg-10 mb-0 mb-lg-10">
                        <div class="row align-items-center">
                            <div class="col-lg-6 mb-4 mb-lg-0">
                                <figure class="br-sm">
                                    <img src="<?php echo base_url(); ?>assets/images/pages/become/2.jpg" alt="Banner"

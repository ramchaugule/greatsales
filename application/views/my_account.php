                ...
                <div class="container">
                    <div class="tab tab-vertical row gutter-lg">
                        <ul class="nav nav-tabs mb-6" role="tablist">
                            ...
                            <li class="nav-item">
                                <a href="<?php echo base_url(); ?>index.php/Menus/my_favourite" class="nav-link">My Favourite</a>
                            </li>
                            <li class="nav-item">
                                <a href="#browsing_history" class="nav-link">Browsing History</a>
                            </li>
                            <li class="nav-item">
                                <a href="#lead_management" class="nav-link">Lead Management</a>
                            </li>
                            <li class="nav-item">
                                <a href="#enquiries" class="nav-link">Enquiries</a>
                            </li>
                            <li class="nav-item">
                                <a href="#post_requirement" class="nav-link">Post Requirements</a>
                            </li>
                            <li class="nav-item">
                                <a href="#account-orders" class="nav-link">My Products</a>
                            </li>
                                
                            <li class="nav-item">
                                <a href="#account-details" class="nav-link">Profile details</a>
                            </li>

                            <li class="nav-item">
                                <a href="#terms_condition" class="nav-link">Terms & Condition</a>
                            </li>
                            <!-- <li class="nav-item">
                        ...
                        <div class="tab-content mb-6">
                            <div class="tab-pane active in" id="account-dashboard">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-4 col-md-6 col-sm-4 col-xs-6 mb-4">
                                        <a href="<?php echo base_url(); ?>index.php/Menus/my_favourite" class="link-to-tab">
                                            <div class="icon-box text-center">
                                                <span class="icon-box-icon icon-wishlist">
                                                    <i class="w-icon-heart"></i>
                                                </span>
                                                <div class="icon-box-content">
                                                    <p class="text-uppercase mb-0">My Favourite</p>
                                                </div>
                                            </div>
                                        </a>
                                    </div>

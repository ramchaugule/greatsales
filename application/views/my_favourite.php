...
<?php include('include/header.php'); ?>
        ...
        <main class="main wishlist-page">
            ...
            <div class="page-header">
                <div class="container">
                    <h1 class="page-title mb-0">My Favourite</h1>
                </div>
            </div>
            <!-- End of Page Header -->
            ...
            <div class="page-content">
                <div class="container">
                    <h3 class="wishlist-title">My Favourite</h3>
                            ...
                            <tr>
                                <td class="product-thumbnail">
                                    <div class="p-relative">
                                        <a href="product-default.html">
                                            <figure>
                                                <img src="<?php echo base_url(); ?>assets/images/shop/19-1.jpg" alt="product" width="300"
                                                    height="338">
                                            </figure>
                                        </a>
                                        <button type="submit" class="btn btn-close"><i
                            ...
                            <tr>
                                <td class="product-thumbnail">
                                    <div class="p-relative">
                                        <a href="product-default.html">
                                            <figure>
                                                <img src="<?php echo base_url(); ?>assets/images/shop/20.jpg" alt="product" width="300"
                                                    height="338">
                                            </figure>
                                        </a>
                                        <button type="submit" class="btn btn-close"><i

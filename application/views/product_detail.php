                ...
                <ul class="product-nav list-style-none">
                    <li class="product-nav-prev">
                        ...
                        <span class="product-nav-popup">
                            <img src="<?php echo base_url(); ?>assets/images/products/product-nav-prev.jpg" alt="Product" width="110"
                                height="110" />
                    ...
                    <li class="product-nav-next">
                        ...
                        <span class="product-nav-popup">
                            <img src="<?php echo base_url(); ?>assets/images/products/product-nav-next.jpg" alt="Product" width="110"
                                height="110" />
                                            ...
                                            <div class="swiper-wrapper row cols-1 gutter-no">
                                                <div class="swiper-slide">
                                                    <figure class="product-image">
                                                        <img src="<?php echo base_url(); ?>assets/images/products/default/1-800x900.jpg"
                                                ...
                                                <div class="swiper-slide">
                                                    <figure class="product-image">
                                                        <img src="<?php echo base_url(); ?>assets/images/products/default/2-800x900.jpg"
                                                ...
                                                <div class="swiper-slide">
                                                    <figure class="product-image">
                                                        <img src="<?php echo base_url(); ?>assets/images/products/default/3-800x900.jpg"
                                                ...
                                                <div class="swiper-slide">
                                                    <figure class="product-image">
                                                        <img src="<?php echo base_url(); ?>assets/images/products/default/4-800x900.jpg"
                                                ...
                                                <div class="swiper-slide">
                                                    <figure class="product-image">
                                                        <img src="<?php echo base_url(); ?>assets/images/products/default/5-800x900.jpg"
                                                ...
                                                <div class="swiper-slide">
                                                    <figure class="product-image">
                                                        <img src="<?php echo base_url(); ?>assets/images/products/default/6-800x900.jpg"
                                        ...
                                        <div class="product-thumbs-wrap swiper-container" data-swiper-options="{
                                            ...
                                            <div class="product-thumbs swiper-wrapper row cols-4 gutter-sm">
                                                <div class="product-thumb swiper-slide">
                                                    <img src="<?php echo base_url(); ?>assets/images/products/default/1-800x900.jpg"
                                                        alt="Produ<?php echo base_url(); ?>ct Thumb" width="800" height="900">
                                                </div>
                                                <div class="product-thumb swiper-slide">
                                                    <img src="<?php echo base_url(); ?>assets/images/products/default/2-800x900.jpg"
                                ...
                                <div class="col-md-6 mb-4 mb-md-6">
                                    <div class="product-details" data-sticky-options="{'minWidth': 767}">
                                        ...
                                        <div class="product-bm-wrapper">
                                            <figure class="brand">
                                                <img src="<?php echo base_url(); ?>assets/images/products/brand/brand-1.jpg" alt="Brand"
                                                    width="102" height="48" />
                                            </figure>
                                ...
                                <div class="bought-together-products row mt-8 pb-4">
                                    <div class="product product-wrap text-center">
                                        <figure class="product-media">
                                            <img src="<?php echo base_url(); ?>assets/images/products/default/bought-1.jpg" alt="Product"
                                    ...
                                    <div class="product product-wrap text-center">
                                        <figure class="product-media">
                                            <img src="<?php echo base_url(); ?>assets/images/products/default/bought-2.jpg" alt="Product"
                                                width="138" height="138" />
                                            <div class="product-checkbox">
                                    ...
                                    <div class="product product-wrap text-center">
                                        <figure class="product-media">
                                            <img src="<?php echo base_url(); ?>assets/images/products/default/bought-3.jpg" alt="Product"
                                                width="138" height="138" />
                                            <div class="product-checkbox">
                                            ...
                                            <div class="col-md-6 mb-5">
                                                <div class="banner banner-video product-video br-xs">
                                                    <figure class="banner-media">
                                                        <a href="#">
                                                            <img src="<?php echo base_url(); ?>assets/images/products/video-banner-610x300.jpg"
                                        ...
                                        <div class="row mb-3">
                                            <div class="col-md-6 mb-4">
                                                <figure class="vendor-banner br-sm">
                                                    <img src="<?php echo base_url(); ?>assets/images/products/vendor-banner.jpg"
                                            ...
                                            <div class="col-md-6 pl-2 pl-md-6 mb-4">
                                                <div class="vendor-user">
                                                    <figure class="vendor-logo mr-4">
                                                        <a href="#">
                                                            <img src="<?php echo base_url(); ?>assets/images/products/vendor-logo.jpg"
                                                ...
                                                <div class="tab-pane active" id="show-all">
                                                    <ul class="comments list-style-none">
                                                        <li class="comment">
                                                            <div class="comment-body">
                                                                <figure class="comment-avatar">
                                                                    <img src="<?php echo base_url(); ?>assets/images/agents/1-100x100.png"
                                                                ...
                                                                <div class="comment-content">
                                                                    ...
                                                                    <div class="comment-action">
                                                                        ...
                                                                        <div class="review-image">
                                                                            <a href="#">
                                                                                <figure>
                                                                                    <img src="<?php echo base_url(); ?>assets/images/products/default/review-img-1.jpg"
                                                                                        width="60" height="60"
                                                        ...
                                                        <li class="comment">
                                                            <div class="comment-body">
                                                                <figure class="comment-avatar">
                                                                    <img src="<?php echo base_url(); ?>assets/images/agents/2-100x100.png"
                                                                        alt="Commenter Avatar" width="90" height="90">
                                                                </figure>
                                                                <div class="comment-content">
                                                                    <h4 class="comment-author">
                                                                    ...
                                                                    <div class="comment-action">
                                                                        ...
                                                                        <div class="review-image">
                                                                            <a href="#">
                                                                                <figure>
                                                                                    <img src="<?php echo base_url(); ?>assets/images/products/default/review-img-2.jpg"
                                                                                        width="60" height="60"
                                                                                        alt="Attachment image of John Doe's review on Electronics Black Wrist Watch"
                                                                            ...
                                                                            <a href="#">
                                                                                <figure>
                                                                                    <img src="<?php echo base_url(); ?>assets/images/products/default/review-img-3.jpg"
                                                                                        width="60" height="60"
                                                                                        alt="Attachment image of John Doe's review on Electronics Black Wrist Watch"
                                                        ...
                                                        <li class="comment">
                                                            <div class="comment-body">
                                                                <figure class="comment-avatar">
                                                                    <img src="<?php echo base_url(); ?>assets/images/agents/3-100x100.png"
                                                                        alt="Commenter Avatar" width="90" height="90">
                                                                </figure>
                                                                <div class="comment-content">
                                                                    <h4 class="comment-author">
                                ...
                                <div class="swiper-container swiper-theme" data-swiper-options="{
                                    ...
                                    <div class="swiper-wrapper row cols-lg-3 cols-md-4 cols-sm-3 cols-2">
                                        <div class="swiper-slide product">
                                            <figure class="product-media">
                                                <a href="product-default.html">
                                                    <img src="<?php echo base_url(); ?>assets/images/products/default/1-1.jpg" alt="Product"
                                                        width="300" height="338" />
                                                    <img src="<?php echo base_url(); ?>assets/images/products/default/1-2.jpg" alt="Product"
                                                        width="300" height="338" />
                                                </a>
                                        ...
                                        <div class="swiper-slide product">
                                            <figure class="product-media">
                                                <a href="product-default.html">
                                                    <img src="<?php echo base_url(); ?>assets/images/products/default/2.jpg" alt="Product"
                                                        width="300" height="338" />
                                                </a>
                                                <div class="product-action-vertical">
                                                    <a href="#" class="btn-product-icon btn-cart w-icon-cart"
                                        ...
                                        <div class="swiper-slide product">
                                            <figure class="product-media">
                                                <a href="product-default.html">
                                                    <img src="<?php echo base_url(); ?>assets/images/products/default/3.jpg" alt="Product"
                                                        width="300" height="338" />
                                                </a>
                                                <div class="product-action-vertical">
                                                    <a href="#" class="btn-product-icon btn-cart w-icon-cart"
                                        ...
                                        <div class="swiper-slide product">
                                            <figure class="product-media">
                                                <a href="product-default.html">
                                                    <img src="<?php echo base_url(); ?>assets/images/products/default/4-1.jpg" alt="Product"
                                                        width="300" height="338" />
                                                    <img src="<?php echo base_url(); ?>assets/images/products/default/4-2.jpg" alt="Product"
                                                        width="300" height="338" />
                                                </a>
                                                <div class="product-action-vertical">
                                                    <a href="#" class="btn-product-icon btn-cart w-icon-cart"
                                ...
                                <div class="swiper-container swiper-theme" data-swiper-options="{
                                    ...
                                    <div class="swiper-wrapper row cols-lg-3 cols-md-4 cols-sm-3 cols-2">
                                        <div class="swiper-slide product">
                                            <figure class="product-media">
                                                <a href="product-default.html">
                                                    <img src="<?php echo base_url(); ?>assets/images/products/default/5.jpg" alt="Product"
                                                        width="300" height="338" />
                                                </a>
                                                <div class="product-action-vertical">
                                                    <a href="#" class="btn-product-icon btn-cart w-icon-cart"
                                        ...
                                        <div class="swiper-slide product">
                                            <figure class="product-media">
                                                <a href="product-default.html">
                                                    <img src="<?php echo base_url(); ?>assets/images/products/default/6.jpg" alt="Product"
                                                        width="300" height="338" />
                                                </a>
                                                <div class="product-action-vertical">
                                                    <a href="#" class="btn-product-icon btn-cart w-icon-cart"
                                        ...
                                        <div class="swiper-slide product">
                                            <figure class="product-media">
                                                <a href="product-default.html">
                                                    <img src="<?php echo base_url(); ?>assets/images/products/default/7-1.jpg" alt="Product"
                                                        width="300" height="338" />
                                                    <img src="<?php echo base_url(); ?>assets/images/products/default/7-2.jpg" alt="Product"
                                                        width="300" height="338" />
                                                </a>
                                                <div class="product-action-vertical">
                                                    <a href="#" class="btn-product-icon btn-cart w-icon-cart"
                                        ...
                                        <div class="swiper-slide product">
                                            <figure class="product-media">
                                                <a href="product-default.html">
                                                    <img src="<?php echo base_url(); ?>assets/images/products/default/8.jpg" alt="Product"
                                                        width="300" height="338" />
                                                </a>
                                                <div class="product-action-vertical">
                                                    <a href="#" class="btn-product-icon btn-cart w-icon-cart"
                                ...
                                <div class="sticky-sidebar">
                                    ...
                                    <div class="widget widget-banner mb-9">
                                        <div class="banner banner-fixed br-sm">
                                            <figure>
                                                <img src="<?php echo base_url(); ?>assets/images/shop/banner3.jpg" alt="Banner" width="266"
                                                ...
                                                <div class="swiper-wrapper">
                                                    <div class="widget-col swiper-slide">
                                                        <div class="product product-widget">
                                                            <figure class="product-media">
                                                                <a href="#">
                                                                    <img src="<?php echo base_url(); ?>assets/images/shop/13.jpg" alt="Product"
                                                        ...
                                                        <div class="product product-widget">
                                                            <figure class="product-media">
                                                                <a href="#">
                                                                    <img src="<?php echo base_url(); ?>assets/images/shop/14.jpg" alt="Product"
                                                                        width="100" height="113" />
                                                                </a>
                                                            </figure>
                                                            <div class="product-details">
                                                        ...
                                                        <div class="product product-widget">
                                                            <figure class="product-media">
                                                                <a href="#">
                                                                    <img src="<?php echo base_url(); ?>assets/images/shop/15.jpg" alt="Product"
                                                                        width="100" height="113" />
                                                                </a>
                                                            </figure>
                                                            <div class="product-details">
                                                    ...
                                                    <div class="widget-col swiper-slide">
                                                        <div class="product product-widget">
                                                            <figure class="product-media">
                                                                <a href="#">
                                                                    <img src="<?php echo base_url(); ?>assets/images/shop/16.jpg" alt="Product"
                                                                        width="100" height="113" />
                                                                </a>
                                                            </figure>
                                                            <div class="product-details">
                                                        ...
                                                        <div class="product product-widget">
                                                            <figure class="product-media">
                                                                <a href="#">
                                                                    <img src="<?php echo base_url(); ?>assets/images/shop/17.jpg" alt="Product"
                                                                        width="100" height="113" />
                                                                </a>
                                                            </figure>
                                                            <div class="product-details">
                                                        ...
                                                        <div class="product product-widget">
                                                            <figure class="product-media">
                                                                <a href="#">
                                                                    <img src="<?php echo base_url(); ?>assets/images/shop/18.jpg" alt="Product"
                                                                        width="100" height="113" />
                                                                </a>
                                                            </figure>
                                                            <div class="product-details">

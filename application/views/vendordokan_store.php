                                    ...
                                    <div class="widget widget-collapsible widget-products">
                                        ...
                                        <div class="widget-body">
                                            <div class="product product-widget">
                                                <figure class="product-media">
                                                    <a href="product-default.html">
                                                        <img src="<?php echo base_url(); ?>assets/images/shop/1.jpg" alt="Product" width="100"
                                                            height="106" />
                                                    </a>
                                                </figure>
                                            ...
                                            <div class="product product-widget">
                                                <figure class="product-media">
                                                    <a href="product-default.html">
                                                        <img src="<?php echo base_url(); ?>assets/images/shop/2-1.jpg" alt="Product" width="100"
                                                            height="106" />
                                                    </a>
                                                </figure>
                                                <div class="product-details">
                                            ...
                                            <div class="product product-widget">
                                                <figure class="product-media">
                                                    <a href="product-default.html">
                                                        <img src="<?php echo base_url(); ?>assets/images/shop/3.jpg" alt="Product" width="100"
                                                            height="106" />
                                                    </a>
                                                </figure>
                                                <div class="product-details">
                                    ...
                                    <div class="widget widget-collapsible widget-products">
                                        ...
                                        <div class="widget-body">
                                            <div class="product product-widget">
                                                <figure class="product-media">
                                                    <a href="product-default.html">
                                                        <img src="<?php echo base_url(); ?>assets/images/shop/12.jpg" alt="Product" width="100"
                                                            height="106" />
                                                    </a>
                                                </figure>
                                                <div class="product-details">
                                            ...
                                            <div class="product product-widget">
                                                <figure class="product-media">
                                                    <a href="product-default.html">
                                                        <img src="<?php echo base_url(); ?>assets/images/shop/13.jpg" alt="Product" width="100"
                                                            height="106" />
                                                    </a>
                                                </figure>
                                                <div class="product-details">
                                            ...
                                            <div class="product product-widget">
                                                <figure class="product-media">
                                                    <a href="product-default.html">
                                                        <img src="<?php echo base_url(); ?>assets/images/shop/20.jpg" alt="Product" width="100"
                                                            height="106" />
                                                    </a>
                                                </figure>
                                                <div class="product-details">
                        ...
                        <div class="main-content">
                            <div class="store store-banner mb-4">
                                <figure class="store-media">
                                    <img src="<?php echo base_url(); ?>assets/images/vendor/dokan/1.jpg" alt="Vendor" width="930" height="446"
                                        style="background-color: #414960;" />
                                </figure>
                                <div class="store-content">
                                    <figure class="seller-brand">
                                        <img src="<?php echo base_url(); ?>assets/images/vendor/brand/1.jpg" alt="Brand" width="80"
                                            height="80" />
                                    </figure>

 ...
 <footer class="footer appear-animate" data-animation-options="{
            ...
            <div class="footer-newsletter" style="background-color: #1f4076;">
                <div class="container">
            ...
            <div class="container">
                        ...
                        <div class="col-lg-4 col-sm-6">
                            <div class="widget widget-about">
                                <a href="demo1.html" class="logo-footer">
                                    <img src="<?php echo base_url(); ?>assets/images/great_logo.png" alt="logo-footer" style="height: 100px; margin-top: -40px;" />
                                </a>
                        ...
                        <div class="col-lg-3 col-sm-6">
                            <div class="widget">
                                ...
                                <ul class="widget-body">
                                    ...
                                    <li><a href="<?php echo base_url(); ?>index.php/Menus/Privacy_Policy">Privacy Policy</a></li>
                                </ul>
                            </div>
                        </div>
                        <div class="col-lg-3 col-sm-6">
                            <div class="widget">
                                ...
                                <ul class="widget-body">
                                    ...
                                    <li><a href="<?php echo base_url(); ?>index.php/Menus/term_conditions">Term and Conditions</a></li>
                                </ul>
                            </div>
                        </div>
                    </div>
                ...
                <div class="footer-bottom">
                    <div class="footer-left">
                        <p class="copyright">Copyright © 2021 Great Sales. All Rights Reserved.</p>
                    </div>
                    <div class="footer-right">
                        <span class="payment-label mr-lg-8">We're using safe payment for</span>
                        <figure class="payment">
                            <img src="<?php echo base_url(); ?>assets/images/payment.png" alt="payment" width="159" height="25" />
                        </figure>
                    </div>
                </div>
            </div>
    ...
    <div class="newsletter-popup mfp-hide">
        <div class="newsletter-content">
            ...
            <h2 class="ls-25">Sign up to Great Sales</h2>
            <p class="text-light ls-10">Subscribe to the Great Sales newsletter to
    ...
    <script src="<?php echo base_url(); ?>assets/vendor/skrollr/skrollr.min.js"></script>
